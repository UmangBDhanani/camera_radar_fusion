...
def read_clib(calib_path):
  ...
  for i, line in enumerate(f):
    if i == 2:
      ...
      return calib
cats = ['Pedestrian', 'Car', 'Cyclist', 'rider', 'truck',  'motor','moped_scooter', 'bicycle',
        'bicycle_rack', 'ride_other', 'human_depiction', 'vehicle_other', 'ride_uncertain','DontCare']
...
H = 384 # 1216
W = 1248 # 1936
# for delft resolution and focal length
# F = 1495
# H = 1216 # 1216
# W = 1936 # 1936
EXT = [0,0,0]
