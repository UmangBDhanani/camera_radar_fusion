...
class KITTI(data.Dataset):
  num_classes = 13
  default_resolution = [384 , 1280]   # for delft --> [1216, 1936]
  ...
  def __init__(self, opt, split):
    ...
    self.max_objs = 50
    self.class_name = ['__background__', 'Pedestrian', 'Car', 'Cyclist','rider', 'truck',  'motor','moped_scooter', 'bicycle',
        'bicycle_rack', 'ride_other', 'human_depiction', 'vehicle_other', 'ride_uncertain']
    self.cat_ids = {1:0, 2:1, 3:2, 4:3, 5:4, 6:5, 7:6, 8:7, 9:8, 10:9, 11:10, 12:11, 13:12, 14:13, 15:-3, 16:-2, 17:-99, 18:-99, 19:-1}
